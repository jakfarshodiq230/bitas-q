...
<script>
    ...
    // Function to load events
        ...
        function loadEvents() {
            $.ajax({
                url: '{{ url('siswa/dashboard/ajax_data_dashboard') }}',
                method: 'GET',
                success: function(response) {
                    ...
                    $.each(response.data, function(index, event) {
                        ...
                        var contentHtml = (event.jenis_periode === 'pbi')
                            ...
                            : `<p class="card-text m-0">${title} sudah dapat dicetak Mulai Tanggal <span class="badge ${batasStatus}">${batas_penilaian}</span><br> </p></p>`;
