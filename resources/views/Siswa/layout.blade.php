        ...
        <nav id="sidebar" class="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ $menu == 'home' ? 'active' : null }}">
						<a class='sidebar-link' href='{{ url('siswa/dashboard')}}'>
							<i class="align-middle me-2 fas fa-fw fa-tachometer"></i> <span class="align-middle">Home</span>
						</a>
					</li>
                    <li class="sidebar-header">
                    ...
                    <li class="sidebar-item {{ $menu == 'kegiatan' ? 'active' : null }}">
						<a class='sidebar-link' href='{{ url('siswa/kegiatan')}}'>
							<i class="align-middle me-2 fas fa-fw fa-list"></i> <span class="align-middle">Al-Qur'an</span>
						</a>
					</li>
                    <li class="sidebar-item {{ $menu == 'bpi' ? 'active' : null }}">
						<a class='sidebar-link' href='{{ url('siswa/bpi')}}'>
							<i class="align-middle me-2 fas fa-fw fa-list"></i> <span class="align-middle">Bina Pribadi Islam (BPI)</span>
						</a>
					</li>
                    <li class="sidebar-item {{ $menu == 'sertifikasi' ? 'active' : null }}">
						<a class='sidebar-link' href='{{ url('siswa/sertifikasi')}}'>
							<i class="align-middle me-2 fas fa-fw fa-list"></i> <span class="align-middle">Sertifikasi Al-Qur'an</span>
						</a>
					</li>
