        ...
        <div class="container-fluid">
            <div class="header">
                <h1 class="header-title">
                    DATA PESERTA RAPOR BINA PRIBADI ISLAM (BPI)
                </h1>
            </div>
            <div class="row">
                <div class="col-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#datatables-ajax').DataTable({
                ...
                destroy: true,
                responsive: true,
                ajax: '{{ url('admin/peserta_rapor_pbi/data_peserta_rapor_pbi') }}',
                columns: [{
                        "data": null,
                        "name": "rowNumber",
        ...
        $(document).on('click', '.syncBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ url('admin/peserta_rapor_pbi/sync') }}/' + tahun + '/' + rapor + '/' + periode,
                        type: 'GET',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
        ...
        $(document).on('click', '.pesertaBtn', function() {
            ...
            var rapor = $(this).data('rapor');
            var periode = $(this).data('periode');
            var url= '{{ url('admin/peserta_rapor_pbi/list_peserta') }}/' + tahun + '/' + rapor + '/' + periode;
