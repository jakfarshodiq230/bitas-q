...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            // identitas
            $.ajax({
                url: '{{ url('admin/peserta_rapor_pbi/ajax_list_peserta') }}/' + tahun + '/' + jenjang + '/' + periode,
                type: 'GET',
        ...
        $(document).on('click', '.lihatBtn', function() {
            ...
            var url= '{{ url('admin/peserta_rapor_pbi/detail_peserta') }}/' + id + '/'+ peserta + '/'+ tahun + '/' + rapor + '/' + periode;
        ...
        $(document).on('click', '.downloadBtn', function() {
            ...
            var periode = $(this).data('periode');
            var url= '{{ url('admin/peserta_rapor_pbi/cetak_rapor_admin') }}/'+ idRapor + '/'+ peserta + '/'+ tahun + '/' + jenjang + '/' + periode;
            window.location.href = url;
        });
    </script>
@endsection
