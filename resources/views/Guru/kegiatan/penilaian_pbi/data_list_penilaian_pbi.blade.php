        ...
        <div class="container-fluid">
            <div class="header">
                <h1 class="header-title" id="judul_header">
                    DATA PENILAIAN PESERTA {{ strtoupper($judul_3) }}
                </h1>
            </div>
            <div class="row">
                <div class="col-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#datatables-ajax').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ url('guru/penilaian_pbi/data_penilaian_kegiatan_list') }}/" + periode + "/" + tahun_ajaran,
                },
                columns: [{
                        "data": null,
                        "name": "rowNumber",
        ...
        $(document).on('click', '.detailBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ url('guru/penilaian_pbi/data_detail_periode_penilaian_pbi') }}/"
                    + id_tahun + "/" 
                    + id_periode + "/"
                    + id_siswa + "/"
                    + id_guru + "/"
        ...
        $(document).on('click', '.printBtn', function() {
            ...
            var url= '{{ url('guru/penilaian_pbi/cetak_kartu') }}/'+ periode + '/'+ tahun + '/' + peserta + '/' + kelas;
            window.location.href = url;
        });
    </script>
@endsection
